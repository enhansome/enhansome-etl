...
* [PETL](https://github.com/petl-developers/petl) ⭐ 1,316 | 🐛 89 | 🌐 Python | 📅 2026-08-19 - "a general purpose Python package for extracting, transforming and loading tables of data."
...
* [CloudQuery](https://github.com/cloudquery/cloudquery) ⭐ 6,495 | 🐛 166 | 🌐 Go | 📅 2026-08-24 - "a cloud asset inventory built for platform teams. Sync your cloud infrastructure metadata into your data warehouse, powering insights and automation."
