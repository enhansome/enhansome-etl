...
* [Jenkins](https://github.com/jenkinsci/jenkins) ⭐ 26,485 | 🐛 3,608 | 🌐 Java | 📅 2026-08-24 - "the leading open-source automation server. Built with Java, it provides over 1000 plugins to support automating virtually anything, so that humans can actually spend their time doing things machines cannot."
...
* [nokogiri](https://github.com/sparklemotion/nokogiri) ⭐ 6,276 | 🐛 117 | 🌐 C | 📅 2026-08-24 - "Nokogiri makes it easy and painless to work with XML and HTML from Ruby."
...
* [CloudQuery](https://github.com/cloudquery/cloudquery) ⭐ 6,492 | 🐛 165 | 🌐 Go | 📅 2026-08-24 - "a cloud asset inventory built for platform teams. Sync your cloud infrastructure metadata into your data warehouse, powering insights and automation."
